...
<head>
    ...
    <title>Dashboard Saya - Dzhirasena</title>
    <!-- Google Fonts -->
    ...
    <div id="page-content">
        ...
        <section id="dashboard-view" class="app-view">
            <div class="view-header-row">
                <div>
                    <h1 class="view-title">Dashboard Kerja Saya</h1>
                    <p class="view-subtitle">Ringkasan aktivitas dan tugas pribadi Anda.</p>
                </div>
                <!-- Mobile Only Button to add task -->
                <button class="btn btn-primary mobile-only-btn" id="btn-add-task-mobile">
            ...
            <div class="metrics-grid">
                <div class="metric-card bg-white-card" data-progress-type="total" style="cursor:pointer;"
                    ...
                    <div class="metric-info">
                        ...
                        <p class="stat-trend trend-neutral">terjadwal</p>
                ...
                <div class="metric-card bg-white-card" data-progress-type="running" style="cursor:pointer;"
                    ...
                    <div class="metric-info">
                        ...
                        <p class="stat-trend trend-neutral">perlu dikerjakan</p>
                        <div class="metric-mini-bar">
                ...
                <div class="metric-card bg-white-card" data-progress-type="completed" style="cursor:pointer;"
                    ...
                    <div class="metric-info">
                        ...
                        <p class="stat-trend trend-up"><span id="completed-percentage-badge">0%</span> selesai</p>
                        <div class="metric-mini-bar">
                ...
                <aside class="desktop-task-widget">
                    <div class="widget-card add-task-card">
                        ...
                        <form id="add-task-form">
                            ...
                            <div class="form-group hidden">
                                ...
                                <select id="task-assignee" disabled>
                    ...
                    <div class="widget-card progress-widget-card">
                        <div class="progress-header">
                            <h3>Weekly Progress Saya</h3>
                            <span id="weekly-progress-percent">0%</span>
                        </div>
                        <div class="progress-bar-container">
                            <div class="progress-bar-fill" id="weekly-progress-bar" style="width: 0%;"></div>
                        </div>
                        <p class="progress-meta">Anda telah menyelesaikan <strong id="weekly-completed-count">0</strong>
                            tugas. Tetap semangat!</p>
                    </div>
                </aside>
            </div>
        </section>
