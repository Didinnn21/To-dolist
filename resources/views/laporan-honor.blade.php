...
<head>
    ...
    <title>Laporan Honor - Dzhirasena</title>
    <!-- Google Fonts -->
...
<body>
    ...
    <div id="page-content">
        <section id="laporan-honor-view" class="app-view">
            ...
            <div class="report-switcher-tabs">
                <a href="/laporan" class="report-tab-btn">Laporan Kinerja</a>
                <a href="/laporan-honor" class="report-tab-btn active">Laporan Honor</a>
            </div>
            ...
            <div class="table-card">
                <div class="card-header" style="padding: 20px 24px; border-bottom: 1px solid var(--border-color); display: flex; justify-content: space-between; align-items: center;">
                    <h3>Rekap Honor Terbayarkan</h3>
                    <div style="font-weight: bold; font-size: 18px; color: var(--brand);" id="total-payout">Total Dibayar: Rp0</div>
                </div>
                <div class="table-responsive">
                    <table class="user-table" id="honor-table">
                        <thead>
                            <tr>
                                <th>Karyawan</th>
                                <th style="text-align: center;">Tugas Dibayar</th>
